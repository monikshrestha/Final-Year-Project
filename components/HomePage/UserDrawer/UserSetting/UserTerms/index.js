      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={styles.fullcont}>
          ...
          <Text style={styles.body}>
            ...
            property rights related to it, still belong to Monik Shrestha.
          </Text>

          <Text style={styles.body}>
            Monik Shrestha is committed to ensuring that the app is as useful
          ...
          <Text style={styles.body}>
            The Sajilo Yatayat app stores and processes personal data that you
            have provided to us, in order to provide my Service. It’s your
            ...
            mean that the Sajilo Yatayat app won’t work properly or at all.
          </Text>

          <Text style={styles.body}>
            The app does use third party services that declare their own Terms
            and Conditions. Link to Terms and Conditions of third party service
            providers used by the app Google Play Services.
          </Text>

          <Text style={styles.body}>
            You should be aware that there are certain things that Monik
            Shrestha will not take responsibility for. Certain functions of the
            ...
            provider, but Monik Shrestha cannot take responsibility for the app
          ...
          <Text style={styles.body}>
            Along the same lines, Monik Shrestha cannot always take
            ...
            you can’t turn it on to avail the Service, Monik Shrestha cannot
            accept responsibility.
          </Text>

          <Text style={styles.body}>
            With respect to Monik Shrestha’s responsibility for your use of the
            ...
            so that we can make it available to you. Monik Shrestha accepts no
          ...
          <Text style={styles.body}>
            ...
            you want to keep using the app. Monik Shrestha does not promise that
          ...
          <Text style={styles.body}>
            ...
            this page. These terms and conditions are effective as of 2021-03-17
          </Text>

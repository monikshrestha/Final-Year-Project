      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={styles.fullcont}>
          ...
          <Text style={styles.body}>
            Monik Shrestha built the Sajilo Yatayat app as a Free app. This
            SERVICE is provided by Monik Shrestha at no cost and is intended for
            ...
            is accessible at Sajilo Yatayat unless otherwise defined in this
            Privacy Policy.
          </Text>

          <Text style={styles.head}>**Information Collection and Use**</Text>

          <Text style={styles.body}>
            For a better experience, while using our Service, I may require you
            to provide us with certain personally identifiable information,
            including but not limited to Location. The information that I
            ...
            party service providers used by the app * [Google Play
            Services](https://www.google.com/policies/privacy/)
          </Text>

          <Text style={styles.head}>**Log Data**</Text>
          ...
          <Text style={styles.head}>**Cookies**</Text>
          ...
          <Text style={styles.head}>**Service Providers**</Text>
          ...
          <Text style={styles.body}>
            ...
            To assist us in analyzing how our Service is used. I want to inform
            ...
            them on our behalf. However, they are obligated not to disclose or
            use the information for any other purpose.
          </Text>

          <Text style={styles.head}>**Security**</Text>
          ...
          <Text style={styles.head}>**Links to Other Sites**</Text>
          ...
          <Text style={styles.head}>**Children’s Privacy**</Text>
          ...
          <Text style={styles.head}>**Changes to This Privacy Policy**</Text>

          <Text style={styles.body}>
            I may update our Privacy Policy from time to time. Thus, you are
            advised to review this page periodically for any changes. I will
            notify you of any changes by posting the new Privacy Policy on this
            page. This policy is effective as of 2021-03-17
          </Text>

...
export default function UserPrivacy({ navigation }) {
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        <Text>
          ...
          Monik built the Travel app as a Free app. This SERVICE
          is provided by Monik at no cost and is intended for use as is. This
          ...
          Conditions, which is accessible at Travel unless otherwise defined in
          ...
          with certain personally identifiable information. The information that
          ...
          Data I want to inform you that whenever you use my Service, in a case
          ...
          the Service, and other statistics. Cookies Cookies are files with a
          ...
          visit and are stored on your device's internal memory. This Service
          does not use these “cookies” explicitly. However, the app may use
          ...
          to use some portions of this Service. Service Providers I may employ
          ...
          how our Service is used. I want to inform users of this Service that
          ...
          any other purpose. Security I value your trust in providing us your
          ...
          security. Links to Other Sites This Service may contain links to other
          sites. If you click on a third-party link, you will be directed to
          ...
          posting the new Privacy Policy on this page. This policy is effective
          as of 2020-09-13 Contact Us If you have any questions or suggestions
